...
/// @{
#define RCC_APB1Periph_TIM1             RCC_APB1ENR_TIM1
#define RCC_APB1Periph_TIM3             RCC_APB1ENR_TIM3
#define RCC_APB1Periph_UART1            RCC_APB1ENR_UART1
#define RCC_APB1Periph_ADC1             RCC_APB1ENR_ADC1
#define RCC_APB1Periph_SYSCFG           RCC_APB1ENR_EXTI
