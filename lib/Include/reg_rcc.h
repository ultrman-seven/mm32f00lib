...
typedef struct {
    ...
    __IO u32 RESERVED0b;                                                        ///< Reserved Register                              offset: 0x18
...
#define RCC_APB1RSTR_DBGMCU             (0x01U << RCC_APB1RSTR_DBGMCU_Pos)        ///< System Configuration register reset

#define RCC_APB1RSTR_EXTI_Pos           (30)
#define RCC_APB1RSTR_EXTI               (0x01U << RCC_APB1RSTR_EXTI_Pos)        ///< System Configuration register reset
...
#define RCC_APB1ENR_EXTI                (0x01U << RCC_APB1ENR_EXTI_Pos)          ///< DAC interface clock enable
